...
router.get("/admin/logout", isAuthenticated(["Admin"]), logoutAdmin);
router.get("/admin/donors", isAuthenticated(["Admin"]), getAllDonors);

/* ========== PATIENT ========== */

router.get("/patient/me", isAuthenticated(["Patient"]), getUserDetails);
router.get("/patient/logout", isAuthenticated(["Patient"]), logoutPatient);
...
router.get("/donor/logout", isAuthenticated(["Donor"]), logoutDonor);
